...
function createData(){
    ...
    if($bookname && $bookpublisher && $bookprice){
        ...
        if(mysqli_query($GLOBALS['con'],$sql)){
            TextNode("success","successfully added data...!");
        ...
        TextNode("error","Provided data in textbox...!");
        }       
}
...
function deleteAll(){
    ...
    if(mysqli_query($GLOBALS['con'],$sql)){
        TextNode("success", "All Record deleted Successfullu...!");
        Createdb();
    }
    else{
        TextNode("error", "Something Went wrong Record can't Deleted");
    }
}
